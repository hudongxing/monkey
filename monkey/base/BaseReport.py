...
if __name__ == '__main__':
    workbook = xlsxwriter.Workbook('11111111.xlsx')
    info = [{'emulator-5554': {'cpu': 'D:\\app\\py\\monkey1\\info\\emulator-5554_cpu.pickle',
                               'battery': 'D:\\app\\py\\monkey1\\info\\emulator-5554_battery.pickle',
                               'men': 'D:\\app\\py\\monkey1\\info\\emulator-5554_men.pickle',
                               'flow': 'D:\\app\\py\\monkey1\\info\\emulator-5554_flow.pickle',
                               'header': {'rom': 770300, 'kel': '2核',
                                          'monkey_log':
                                              'D:\\app\\py\\monkey1\\log\\55dd9a83-3337-46d5-bb1f-6f64b85be7cbmonkey.log',
                                          'beforeBattery': 99, 'pix': '1440x810', 'time': '10秒', 'afterBattery': 99,
                                          'phone_name':
                                              'GT-I9500_samsung_4.4', 'net': 'gprs'},
                               'fps': 'D:\\app\\py\\monkey1\\info\\emulator-5554_fps.pickle'}},
            ]
